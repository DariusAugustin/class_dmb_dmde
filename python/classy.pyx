...
# MANUEL:
# the following are additions definitions of mine.

    def Omega_cdm(self):
      return self.ba.Omega0_cdm

    def Omega_chi(self):
      return self.ba.Omega0_chi

    def Vrms2(self, z):
      if ((1.+z) >= 1.e3):
        return self.ba.Vrms2
      else:
        return self.ba.Vrms2 * ((1.+z)*1.e-3)**2

    def omega_dm_tot(self):
      return (self.ba.Omega0_cdm + self.ba.Omega0_chi)*self.ba.h**2
    ...
    def sigma0(self):
      ...
      [cm^2]
      """
      return self.th.sigma_0*1.e4

    def ene(self):
      return self.th.pow_n
    ...
    def z_thdec(self):
      ...
      """
      return self.th.z_thdec

    def z_tcdec(self):
      """
      kinetic decoupling redshift
      """
      return self.th.z_tcdec

    def chidm_temperature(self, z):
        """
        chidm_temperature(z)

        Return the temperature [K] of the chiDM for a given redshift z
        ...
        if self.th.compute_dm_thermo==_FALSE_:
            raise ValueError("This function cannot be called, since compute_dm_thermo = FALSE")
        ...
        Tx = pvecthermo[self.th.index_th_Tx]
    ...
    def Rx(self, z):
        ...
        Return the momentum exchange rate [1/Mpc] of the chiDM for a given redshift z
        ...
        Rx = pvecthermo[self.th.index_th_Rx]
    ...
    def Rx_prime(self, z):
        ...
        Return the heat exchange rate [1/Mpc] of the chiDM for a given redshift z
        ...
        Rx_prime = pvecthermo[self.th.index_th_Rxprime]
...
# MANUEL
                ...
                value = self.th.sigma_0*1.e4
            elif name == 'logmx':
                value = log(self.th.mx)/log(10.)
            elif name == 'logs0':
                value = log(self.th.sigma_0)/log(10.)
# MANUEL
            elif name == 'n_t':
                value = self.pm.n_t
            elif name == 'alpha_t':
