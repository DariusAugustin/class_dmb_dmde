...
struct background
{
  ...
  double xhi_ixc; /**< \f$ xhi_{idecdm} \f$: interaction stregnth between dark matter and dark energy */
...
//MANUEL
  double Omega0_chi; /* Interacting DM */
  double Vrms2;     // simplified Root-Mean-Square of the DM bulk velocity, in natural units. See 1311.2937 and 1802.06788. CHECK: move to "thermodynamics" module ASAP.
//MANUEL
...
//MANUEL
  int index_bg_Vrms2;          // the index for the RMS of the DM bulk velocity.
  int index_bg_rho_chi;        // the index for the chiDM (IDM-b) energy density
//MANUEL
...
//MANUEL
  short has_Vrms2;      // presence of the simplified RMS of the DM bulk velocity. CHECK: move to "thermodynamics" module ASAP.
  short has_chi;        // presence of chiDM (IDM-b)
//MANUEL
...
#define _Gyr_over_Mpc_ 3.06601394e2 /**< conversion factor from megaparsecs to gigayears (c=1 units, Julian years of 365.25 days) */

#define _c_ 2.99792458e8            /**< c in m/s */

//MANUEL: ORIGINAL
// #define _G_ 6.67428e-11             /**< Newton constant in m^3/Kg/s^2 *///MANUEL: ORIGINAL
// #define _eV_ 1.602176487e-19        /**< 1 eV expressed in J *///MANUEL: ORIGINAL
...
//MANUEL: NEW: updated SI values
#define _G_ 6.67430e-11             /**< Newton constant in m^3/Kg/s^2 */
// EXACT VALUES:
#define _eV_ 1.602176634e-19        /**< 1 eV expressed in J */
#define _k_B_ 1.380649e-23
#define _h_P_ 6.62607015e-34
//MANUEL: NEW: updated SI values

//MANUEL: useful values
#define _MeV_over_kg_ 1.782661921627898e-30 // converts MeV to kg: (10^6 * e)/c^2
#define _MeV_times_m_ 5.067730716156395e12 // converts MeV to 1/m: (10^6 * e)/(hbar * c); with hbar = hP(2*PI)
#define _mpl_MeV_ 2.43532e21 // reduced Planck mass in MeV: sqrt( (hbar*c)/(8*PI*G) ) * c^2 / (10^6 * e)
//MANUEL
