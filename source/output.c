...
//MANUEL
    if (pth->compute_dm_thermo == _TRUE_) {
      fprintf(thermofile,"#     Tx = Dark Matter temperature \n");
      fprintf(thermofile,"#  c_x^2 = Dark Matter sound speed squared \n");
      fprintf(thermofile,"#     Rx = Dark Matter-baryon momentum exchange rate \n");
      fprintf(thermofile,"#     Rxprime = Dark Matter-baryon heat exchange rate \n");
    }
// MANUEL
